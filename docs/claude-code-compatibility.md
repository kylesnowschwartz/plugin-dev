...
Last audited: Claude Code 2.1.89 (2026-04-01)
Plugin-dev version: 0.10.0

## Audit Log

| plugin-dev | CC version range | Date | Notes |
|---|---|---|---|
| v0.10.0 | 2.1.89 | 2026-04-01 | PreToolUse "defer" permission, hook output >50K to disk, TaskCreated event (26th), MCP truncation guidance, security monitor expansion |
