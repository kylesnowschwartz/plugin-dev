...
Last audited: Claude Code 2.1.191 (2026-06-25)
...
|---|---|---|---|
| v0.24.1 | 2.1.184-2.1.191 | 2026-06-25 | `/rewind` command, MCP ReadMcpResourceDirTool, MCP retry logic improvements, hooks comma-separated matchers fix, `/permissions` denials persistence fix |
